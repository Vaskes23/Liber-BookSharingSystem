...
<header>
   ...
   <div class="content">
    ...
    <section id="carouselMovies">
        ...
        $genres = $_POST['genres'];
                                                                                                                                //zjisti jaky je zadany zanr

        $dbMovies =  mysqli_connect('localhost','admin','penis','vascakmatyas_movies');

        if($genres == '0' OR $genres == null){
            $sql = "SELECT * FROM movies WHERE category = 0";                                                    //vypise filmy kterre jsou v zadanem kategorii
        }else{
        $sql = "SELECT * FROM movies WHERE category = 0 AND genre = '$genres'";                                 //vypise fikmy kterre jsou v zadanem zanru
        }
