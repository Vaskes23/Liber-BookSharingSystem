...
class DirectorsCarousell{
    public function __construct(){
        $this->mysql=mysqli_connect('localhost','admin','penis','vascakmatyas_movies');
    }
     public function famousDirectors(){
        ...
        $result = mysqli_query($this->mysql, $sql);
        while ($row = mysqli_fetch_array($result)){
                                                                                                                                        //generuje carousel s filmy podle dat v DB se skore lepsi nez 70%
            echo"<div class='imgDiv'>";
            echo"<img src='img/".$row['image']."'>";
            echo"<h2>".$row['name']."</h2>";
            echo "<p>".$row['text']."</p>";
        ...
        $dbUser =  mysqli_connect('localhost','admin','penis','vascakmatyas_users');
